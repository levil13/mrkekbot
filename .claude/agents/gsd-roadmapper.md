...
Reference full template: `/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/templates/state.md`.
