...
- Usage: Reference from command with `@/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/ilia/IdeaProjects/mrkekbot/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/ilia/IdeaProjects/mrkekbot/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
