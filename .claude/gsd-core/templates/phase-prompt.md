...
<!-- For checkpoint task examples and patterns, see @/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
