...
```
Agent(
  prompt="Read /home/ilia/IdeaProjects/mrkekbot/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/templates/VALIDATION.md`
