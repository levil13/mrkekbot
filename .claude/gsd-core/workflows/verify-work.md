...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/workflows/diagnose-issues.md
