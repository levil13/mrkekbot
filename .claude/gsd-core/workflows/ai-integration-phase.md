...
<required_reading>
@/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/references/ai-frameworks.md
@/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/ilia/IdeaProjects/mrkekbot/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/ilia/IdeaProjects/mrkekbot/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/ilia/IdeaProjects/mrkekbot/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/ilia/IdeaProjects/mrkekbot/.claude/agents/gsd-eval-planner.md for instructions.
