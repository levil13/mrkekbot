...
ones). Reference: @/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/ilia/IdeaProjects/mrkekbot/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/ilia/IdeaProjects/mrkekbot/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/templates/spec.md.
