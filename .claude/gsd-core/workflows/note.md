...
- **Global scope**: `/home/ilia/IdeaProjects/mrkekbot/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/ilia/IdeaProjects/mrkekbot/.claude/notes/`)
...
2. Glob `/home/ilia/IdeaProjects/mrkekbot/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/ilia/IdeaProjects/mrkekbot/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/ilia/IdeaProjects/mrkekbot/.claude/notes/` — works in any directory
