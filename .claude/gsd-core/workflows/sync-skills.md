...
INSTALL_JS_GLOBAL="/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
