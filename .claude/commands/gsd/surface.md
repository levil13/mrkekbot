...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/ilia/IdeaProjects/mrkekbot/.claude/.gsd-surface.json`
(sibling to `/home/ilia/IdeaProjects/mrkekbot/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/ilia/IdeaProjects/mrkekbot/.claude/skills/gsd-*/`.
...
(`/home/ilia/IdeaProjects/mrkekbot/.claude`), NOT the skills sub-directory (`/home/ilia/IdeaProjects/mrkekbot/.claude/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/home/ilia/IdeaProjects/mrkekbot/.claude` as `configDir`. The skill dirs themselves live at
`/home/ilia/IdeaProjects/mrkekbot/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/home/ilia/IdeaProjects/mrkekbot/.claude}"
SCOPE="global"
...
(i.e. `/home/ilia/IdeaProjects/mrkekbot/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/ilia/IdeaProjects/mrkekbot/.claude/.gsd-surface.json`
Install profile marker: `/home/ilia/IdeaProjects/mrkekbot/.claude/.gsd-profile`
Skill dirs: `/home/ilia/IdeaProjects/mrkekbot/.claude/skills/gsd-*/`
Engine module: `/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/ilia/IdeaProjects/mrkekbot/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
